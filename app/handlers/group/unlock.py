...
async def func_unlock(_, message: Message):
    ...
    if chat_admins.is_user_admin and not chat_admins.is_user_admin.can_change_info:
        await message.reply_text("You don't have enough permission to unlock this chat!")
        return
    ...
    if not chat_admins.is_bot_admin.can_change_info:
        await message.reply_text("I don't have enough permission to unlock this chat!")
        return
